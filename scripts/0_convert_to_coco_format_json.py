...
def split_and_convert_to_coco(json_dir, image_dir, output_dir, train_ratio=0.7, image_width=3904, image_height=3904):
    def initialize_coco():
        return {
            "images": [],
            "annotations": [],
...
# 실행
json_directory = '/home/a/A_2024_selfcode/PCB_DETR/raw_datasets/2_raw_json'  # JSON 파일 경로
image_directory = '/home/a/A_2024_selfcode/PCB_DETR/raw_datasets/1_images'  # 이미지 파일 경로
output_directory = '/home/a/A_2024_selfcode/PCB_DETR/datasets'  # 결과 저장 경로

split_and_convert_to_coco(json_directory, image_directory, output_directory, train_ratio=0.7)
